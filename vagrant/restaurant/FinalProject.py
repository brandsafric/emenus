...
def deleteMenuItem(restaurant_id, menu_id):
    ...
    if login_session['user_id'] != restaurant.user_id:
        return "<script>function myFunction() {alert('You are not authorized to delete menu items to this restaurant. Please create your own restaurant in order to delete items.');window.location.href = '/restaurant/" + str(restaurant_id) + "menu';}</script><body onload='myFunction()''>"
    if request.method == 'POST':
