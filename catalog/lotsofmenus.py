...
restaurant3 = Restaurant(user_id=1, name="Panda Garden", cuisine="Thai", picture_id=9)
...
restaurant4 = Restaurant(user_id=1, name="Thyme for That Vegetarian Cuisine", cuisine="Vegetarian", picture_id=6)
...
restaurant5 = Restaurant(user_id=1, name="Tony\'s Bistro", cuisine="American", picture_id=5)
...
# Menu for Andala's
restaurant6 = Restaurant(user_id=1, name="Andala\'s", cuisine="American/Sushi", picture_id=3)
...
restaurant7 = Restaurant(user_id=1, name="Auntie Ann\'s Diner'", cuisine="American Diner", picture_id=10)
...
restaurant8 = Restaurant(user_id=1, name="Cocina Y Amor", cuisine="Mexican", picture_id=6)
...
restaurant9 = Restaurant(user_id=1, name="State Bird Provisions", cuisine="American French Fusion", picture_id=4)
