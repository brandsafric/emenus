        ...
        try:
            ...
            if self.path.endswith("/edit"):
                ...
                if myRestaurantQuery != []:
                    ...
                    output += "<form method='POST' enctype='multipart/form-data'" \
                              " action='/restaurants/{0}/edit' >".format(restaurantIDPath)
                    output += "<input name= 'newRestaurantName' type='text'" \
                              "placeholder = '{0}' >".format(myRestaurantQuery.name)
            ...
            if self.path.endswith("/delete"):
                ...
                if myRestaurantQuery:
                    ...
                    output = ""
                    output += "<html><body>"
                    output += "<h1>Are you sure you want to delete {0}?".format(myRestaurantQuery.name)
    ...
    def do_POST(self):
        try:
           ...
           if self.path.endswith("/restaurants/new"):
               ...
               # Create the new Restaurant class
